...
surface.create_entity{name = "dps-building_promethium-subcore", force = "enemy", position = {0,0}}
UTIL_ensure_entity(surface, { name = "dps-building_promethium-subcore-container", position = {0,0}, hidden = true})
