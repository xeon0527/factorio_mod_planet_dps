...
data:extend {
...

  {
    ...
    auto_recycle = false,
    energy_required = 0.2,
    ingredients = {{type = "item", name = "dps-item_dps-scrap", amount = 1}},
    results =
    {
      ...
      --{type = "item", name = "dps-item_dps-subcore-fragment",    amount = 1, shared_probability = { min = 0.49, max = 0.495 }, show_details_in_recipe_tooltip = false},
    }
  },
}